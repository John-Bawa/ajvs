...
export default function Blog() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <SEOHead
        title="Blog & News"
        description="Read the latest news, research updates, and announcements from the African Journal of Veterinary Sciences."
        canonicalUrl="https://africanjournalvetsci.org/blog"
        keywords={["AJVS blog", "veterinary news", "research updates", "journal news"]}
        breadcrumbs={[
      ...
      <section className="bg-gradient-to-br from-primary/5 via-background to-accent/5 py-12 sm:py-16">
        <div className="container mx-auto px-4 sm:px-6 text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-serif font-bold text-foreground mb-4">Blog & News</h1>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-8">
              Latest updates, research highlights, and announcements from AJVS
            </p>
